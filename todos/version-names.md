...
Release codenames are puns on real work tools, with a nod to what HQ does — pulling scattered
context back together. **v1.0.0 = "Notion Sickness".**

| Codename | Tool | The pun / why it fits |
|----------|------|------------------------|
| **Notion Sickness** ✅ v1.0.0 | Notion | "Motion sickness" — the dizziness of tab-hopping across ten tools, which HQ cures. |
...
| Slacksimum | Slack | "Maximum Slack" — peak signal, minimum noise. |
| Dust to Dust | Dust | Nothing decays into a forgotten backlog; it all comes back around. |

Ideas for future releases — pick one per minor/major and keep the running gag going.
