...
export function makeTasks(): Task[] {
  return [
    ...
    },
    {
      ...
      items: [
        {
          id: 'pr:acme/webapp:1187',
          source: 'pr',
          label: 'feat(auth): base session store',
          url: 'https://github.com/acme/webapp/pull/1187',
          context: '#1187',
          occurred_at: minutesAgo(1460),
          triaged: true,
          triage_reason: null,
          triaged_at: null,
          pr_status: 'approved',
        ...
        {
          id: 'branch:webapp:dev~auth-base',
          source: 'branch',
          label: '[webapp] dev/auth-base',
          url: null,
          context: 'webapp',
          occurred_at: minutesAgo(1520),
          triaged: true,
          triage_reason: null,
          triaged_at: null,
          pr_status: null,
